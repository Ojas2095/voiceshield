...
CATEGORIES: List[Category] = [
    ...
    Category("authority_impersonation", 0.40, [
        ...
        r"(सतर्कता\s*कार्यालय|कार्यालय|कार्याले|कमटनी|सतर्कता|विद्युत\s*विभाग|बिजली\s*विभाग)",
    ...
    Category("urgency_threat", 0.35, [
        ...
        r"तुरंत", r"जल्दी", r"बंद\s*हो\s*जाएगा", r"बकाया", r"लिजली", r"kisi\s*ko\s*mat\s*bata",
